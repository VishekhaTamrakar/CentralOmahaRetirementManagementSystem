...
class resident(unittest.TestCase):
    ...
    def test_resident(self):
        ...
        driver.get("https://orc-team3-project.herokuapp.com/accounts/login/")
        elem = driver.find_element_by_id("id_username")
        elem.send_keys(user)
        elem = driver.find_element_by_id("id_password")
        elem.send_keys(pwd)
        elem.send_keys(Keys.RETURN)
        driver.get("https://orc-team3-project.herokuapp.com/home/")
        assert "Logged In"
        time.sleep(1)
        driver.get("https://orc-team3-project.herokuapp.com/resident/3/workorderview/")
        time.sleep(1)
        driver.get("https://orc-team3-project.herokuapp.com/workorder/new/")
        time.sleep(1)
        ...
        elem.send_keys()
        self.driver.find_element_by_xpath("//*[@id='id_is_open']").click()
        time.sleep(1)
        driver.find_element_by_xpath("//*[@id='content']/form/button").click()
        time.sleep(5)
        driver.find_elements_by_xpath("<b style='color: white'>My Account</b>")
