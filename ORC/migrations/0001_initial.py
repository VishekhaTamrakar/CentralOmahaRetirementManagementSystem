# Generated by Django 2.1.5 on 2019-12-07 05:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Workorder',
            fields=[
                ('workorder_id', models.CharField(auto_created=True, max_length=20, primary_key=True, serialize=False)),
                ...
                ('resident_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='residentid', to='ORC.Resident')),
                ('resident_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='residentname', to='ORC.Resident')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='maintenancework',
            name='residentname',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='res', to='ORC.Resident'),
        ),
        migrations.AddField(
            model_name='maintenancework',
            name='worker_id',
