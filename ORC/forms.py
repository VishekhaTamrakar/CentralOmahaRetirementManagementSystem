...
class MaintenanceWorkForm(forms.ModelForm):
    class Meta:
        ...
        fields = ('user','residentid', 'maintenancework_id','maintenancework_description', 'workorder_id','maintenanceworker_name','property_number','equipment_name','maintenancework_cost','maintenancework_opendate','maintenancework_duedate','is_open','maintenancework_closedate')
